    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SaleInvoices_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SaleInvoiceItems_StockBatches_StockBatchId",
            ...
            migrationBuilder.InsertData(
                table: "Branches",
                columns: new[] { "Id", "AddressLine1", "AddressLine2", "City", "Code", "Country", "IsActive", "Name", "Phone", "PostalCode", "State" },
                values: new object[] { 1, null, null, "Head Office", "MAIN", null, true, "Main Branch", null, null, null });
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "BranchId", "Email", "FullName", "IsActive", "PasswordHash", "Phone", "Username" },
                values: new object[] { 1, 1, "admin@example.com", "System Administrator", true, "admin123", null, "admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SaleInvoiceItems_StockBatchId",
                table: "SaleInvoiceItems",
                column: "StockBatchId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SaleInvoices_PatientId",
                table: "SaleInvoices",
                column: "PatientId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockBatches_MedicineId",
                table: "StockBatches",
                column: "MedicineId");
